#______________ DISTRIBUCI�N Z ______________
...
# se ajustan a una distribuci�n Normal, 
# donde la media de la prueba es 72 y 
# la desviacion est�ndar es 15.2. 
...
x1<-pnorm(9, mean=7.6, sd=1.92, lower.tail = FALSE)
x1*100
